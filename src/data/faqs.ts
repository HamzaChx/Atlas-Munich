...
export const faqs: FAQ[] = [
  // General / Newcomer FAQs
  {
    ...
    answer:
      "Priority tasks: 1) Get a SIM card, 2) Find temporary housing if needed, 3) Book Anmeldung appointment, 4) Open a bank account. See our 'First Weeks in Munich' guide for a complete checklist.",
  ...
  },
  {
    ...
    answer:
      "Budget around €1000-1400/month minimum: Rent €500-800, Food €400-500, Transport €43 (Deutschland Ticket), Health Insurance €140, Others €100-150. Munich is one of Germany's most expensive cities.",
  ...
  },
  {
    ...
    answer:
      "Yes! Munich has top universities (TUM, LMU), a strong job market, excellent public transport, beautiful surroundings (Alps nearby), and a vibrant international community. The main challenges are high rents and finding housing.",
    tags: ["newcomer"],
  },
