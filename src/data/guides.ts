...
export const guides: Guide[] = [
  ...
  // ============================================
  {
    ...
    summary: "Complete guide to student jobs in Munich - from finding opportunities to understanding work permits and salary expectations.",
    categoryKey: "career",
    tags: ["tips", "newcomer"],
    lastUpdated: "2025-12-15",
    readingTime: 10,
    ...
    faqs: [
      {
        ...
        answer: "During semester, stay within 20 hours/week to maintain student benefits. However, during semester breaks you can work full-time without issues.",
      },
      {
        id: "faq-2",
        question: "Do I need to speak German for all jobs?",
        answer: "Not necessarily. Many international companies in Munich (especially tech) operate in English. However, basic German (A2-B1) opens many more opportunities and helps with integration.",
      },
      {
        id: "faq-3",
        question: "What's the difference between 120 full days and 240 half days?",
        answer: "You can work either 120 days at any hours, OR 240 days at max 4 hours per day. Werkstudent jobs (up to 20h/week) count as half days, so you can work nearly year-round.",
      },
    ],
    resources: [
      { id: "r1", title: "StepStone", url: "https://www.stepstone.de/", type: "official", description: "Major German job portal" },
      { id: "r2", title: "Indeed Germany", url: "https://de.indeed.com/", type: "official", description: "Job search engine" },
      { id: "r3", title: "LinkedIn", url: "https://linkedin.com", type: "tool", description: "Professional networking" },
      { id: "r4", title: "Zenjob", url: "https://www.zenjob.com/", type: "tool", description: "Flexible student jobs" },
      { id: "r5", title: "TUM Career Service", url: "https://www.community.tum.de/career-service/", type: "official", description: "TUM career support" },
    ],
  ...
  },
  {
    ...
    summary: "How to write a CV and cover letter that works for German employers, including format, photo requirements, and cultural tips.",
    categoryKey: "career",
    tags: ["tips", "documents"],
    lastUpdated: "2025-12-15",
    readingTime: 8,
    ...
    faqs: [
      {
        ...
        answer: "While not legally required, most German employers still expect it. Including a professional photo is recommended, especially for Moroccan students in Munich's competitive job market.",
      },
      {
        id: "faq-2",
        question: "Should I write my CV in German or English?",
        answer: "Write in the language of the job posting. If the job is posted in German, use German. If it's in English (common in tech/startups), English is fine. When in doubt, prepare both versions.",
      },
      {
        id: "faq-3",
        question: "How do I list my Moroccan degree equivalents?",
        answer: "List your actual degree name, then add the German equivalent in parentheses. For example: 'Bachelor en Sciences (entspricht Bachelor of Science)'. University career centers can help with equivalencies.",
      },
    ],
    resources: [
      { id: "r1", title: "TUM Career Service CV Help", url: "https://www.community.tum.de/career-service/", type: "official", description: "Free CV reviews and templates" },
      { id: "r2", title: "LMU Career Center", url: "https://cs-lmu.matorixmatch.de/?&lang=en_UK", type: "official", description: "Career counseling and workshops" },
    ],
