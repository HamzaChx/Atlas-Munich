        ...
        {sections.map((section) => (
          <li key={section.id}>
            <a
              ...
              className={cn(
                "block rounded-md py-1.5 pl-3 transition-colors hover:text-white",
                activeId === section.id
                  ? "border-l-2 border-emerald-500 bg-emerald-500/10 font-medium text-emerald-400"
                  : "border-l-2 border-transparent text-zinc-500 hover:border-zinc-600"
              )}
            >
              {section.title}
            </a>
                ...
                {section.subsections.map((sub) => (
                  <li key={sub.id}>
                    <a
                      ...
                      className={cn(
                        "block rounded-md py-1 pl-6 text-sm transition-colors hover:text-white",
                        activeId === sub.id
