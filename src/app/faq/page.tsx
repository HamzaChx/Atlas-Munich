    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <section className="relative overflow-hidden border-b border-white/5 bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950">
        ...
        <div className="absolute inset-0 opacity-[0.03]">
          <svg className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="moroccan-faq" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
            ...
            <rect width="100%" height="100%" fill="url(#moroccan-faq)"/>
          </svg>
        </div>

        {/* Gradient Orbs */}
        <div className="absolute -left-32 top-0 h-[400px] w-[400px] rounded-full bg-gradient-to-br from-blue-600/20 to-indigo-600/20 blur-[100px]" />
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-zinc-300">{allFaqs.length}+ Questions Answered</span>
            </div>
            ...
            <div className="relative mx-auto mt-10 max-w-xl">
              ...
              <Input
                ...
                className="h-14 rounded-full border-white/10 bg-white/5 pl-12 text-base text-white placeholder:text-zinc-500 focus:border-blue-500/50 focus:ring-blue-500/20"
              />
            </div>
      ...
      <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                {faqsByCategory && Object.entries(faqsByCategory).map(([categoryKey, categoryFaqs]) => {
                  ...
                  return (
                    <section key={categoryKey}>
                      <h2 className="mb-4 flex items-center gap-2 text-xl font-bold tracking-tight text-white">
                        <span className="inline-block h-1 w-6 rounded-full bg-gradient-to-r from-emerald-400 to-teal-400" />
                        {title}
                      </h2>
                      <div className="rounded-2xl border border-white/10 bg-zinc-900/50 p-6 backdrop-blur-sm">
        ...
        <div className="mt-16 rounded-2xl border border-white/10 bg-gradient-to-br from-zinc-900 via-zinc-900/80 to-zinc-900 p-8 text-center backdrop-blur-sm">
          ...
          <h3 className="text-xl font-semibold text-white">Can&apos;t find what you&apos;re looking for?</h3>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/guides"
              className="group inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-5 py-2.5 text-sm font-medium text-zinc-300 transition-all hover:border-emerald-500/50 hover:bg-emerald-500/10 hover:text-emerald-400"
            >
              Browse Guides
