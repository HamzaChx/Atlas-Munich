  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        {/* Gradient orbs */}
        <div className="pointer-events-none absolute -left-32 -top-32 h-64 w-64 rounded-full bg-emerald-500/10 blur-3xl" />
        <div className="pointer-events-none absolute -right-32 -bottom-32 h-64 w-64 rounded-full bg-teal-500/10 blur-3xl" />
            ...
            <div className="flex flex-wrap gap-2">
              {allTags.map((tag) => (
                <Badge 
                  key={tag} 
                  variant="outline" 
                  className="cursor-pointer border-white/10 bg-zinc-900/50 text-zinc-400 hover:border-emerald-500/30 hover:bg-emerald-500/10 hover:text-emerald-300 capitalize transition-colors"
                >
                  {tag}
                </Badge>
              ))}
