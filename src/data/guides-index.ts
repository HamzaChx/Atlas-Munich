...
export const guidesIndex: GuideMeta[] = [
  ...
  },
  {
    ...
    summary:
      "Register within 14 days at a Bürgerbüro. Bring passport and Wohnungsgeberbestätigung (landlord confirmation). No walk-ins - book online at muenchen.de/termin.",
  ...
  },
  {
    ...
    summary:
      "Apply online via Munich Immigration website before your visa expires. Need: passport, enrollment proof, health insurance, blocked account/funds proof. Processing: 4-8 weeks. Cost: ~€100.",
    category: "immigration",
    lastVerified: "2025-12-01",
  ...
  },
  {
    ...
    summary:
      "Apply 3-4 months before expiry. After 4th semester, bring study progress proof. If applied in time, your old permit stays valid (Fiktionswirkung).",
    category: "immigration",
    lastVerified: "2025-12-01",
  ...
  },
  {
    ...
    summary:
      "Temporary paper confirming your permit is valid while application is processed. Needed for travel, employers, or when card expires before new one arrives.",
    category: "immigration",
    lastVerified: "2025-12-01",
  ...
  },
  {
    ...
    summary:
      "For expiring permits, urgent travel (7 days), or job/benefit risks. Emergency slots appear online same day (early AM). Bring proof of emergency.",
    category: "immigration",
    lastVerified: "2025-12-01",
  ...
  },
  {
    ...
    summary:
      "CV style, job boards, career fairs, and networking for Munich. Non-EU: 120 full days or 240 half days work allowed per year.",
    category: "careers",
    lastVerified: "2025-12-01",
