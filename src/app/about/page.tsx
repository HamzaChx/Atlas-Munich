...
export default async function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* ========== HERO ========== */}
      <section className="mx-auto flex max-w-2xl flex-col items-center px-5 pb-14 pt-14 text-center sm:pb-20 sm:pt-20">
      ...
      <div className="mx-auto max-w-6xl px-4 pb-16 sm:px-6 sm:pb-24 lg:px-8">
        ...
        <section className="reveal mb-16 sm:mb-24">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            {values.map((value) => (
              <div
                key={value.title}
                className={`rounded-3xl p-7 ${value.tint} dark:ring-1 dark:ring-white/10`}
              >
                <span className="mb-5 flex h-11 w-11 items-center justify-center rounded-xl bg-card/80 shadow-sm">
        ...
        <section id="community" className="reveal mb-16 scroll-mt-24 sm:mb-24">
          <div className="rounded-[2rem] bg-tint-green p-7 sm:p-12 dark:ring-1 dark:ring-white/10">
        ...
        <section id="contribute" className="reveal mb-16 scroll-mt-24 sm:mb-24 lg:grid lg:grid-cols-12 lg:gap-12">
          ...
          <div className="mt-10 lg:col-span-7 lg:mt-0">
            <div className="rounded-3xl bg-card p-6 shadow-[0_2px_20px_rgb(0_0_0/0.06)] sm:p-8 dark:shadow-none dark:ring-1 dark:ring-white/10">
              ...
              <h3 className="font-display mt-3 text-xl font-bold tracking-tight text-zinc-900 dark:text-white">
              ...
              <div className="mt-6 space-y-2">
                {contributors.map((contributor) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex items-center gap-4 rounded-2xl px-3 py-3 transition-colors hover:bg-zinc-100/70 dark:hover:bg-white/5"
                  >
                    <span
                    ...
                    <span className="min-w-0 flex-1">
                      <span className="block truncate text-sm font-semibold text-zinc-900 transition-colors group-hover:text-zellige dark:text-white">
                        {contributor.name}
                      </span>
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    <span className="block text-sm font-semibold text-zinc-900 transition-colors group-hover:text-zellige dark:text-white">
                      {t("contributors.you")}
                    </span>
                    <span className="block text-xs text-zinc-500 dark:text-zinc-400">
