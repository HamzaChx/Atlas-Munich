...
export default async function GuidePage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950">
      {/* Header */}
      <section className="relative overflow-hidden border-b border-zinc-200 dark:border-white/5 bg-gradient-to-br from-zinc-50 via-white to-zinc-50 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950">
        ...
        {/* Gradient Orbs */}
        <div className="absolute -left-32 top-1/4 h-[300px] w-[300px] rounded-full bg-gradient-to-br from-emerald-400/30 dark:from-emerald-600/20 to-teal-400/30 dark:to-teal-600/20 blur-[100px]" />
        <div className="absolute -right-32 bottom-0 h-[300px] w-[300px] rounded-full bg-gradient-to-br from-cyan-400/25 dark:from-cyan-500/15 to-blue-400/25 dark:to-blue-600/15 blur-[100px]" />
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="mt-6">
            ...
            <div className="mb-4 flex flex-wrap items-center gap-2">
              <Badge variant="secondary" className="border-emerald-300 dark:border-emerald-500/30 bg-emerald-100 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 capitalize">
                {guide.categoryKey.replace(/-/g, " ")}
              </Badge>
              {guide.tags.map((tag) => (
                <Badge key={tag} className={`${tagColors[tag]} border-zinc-200 dark:border-white/10`}>
                  {tag}
                </Badge>
              ))}
            </div>
          ...
          <article className="min-w-0">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none prose-headings:text-zinc-900 dark:prose-headings:text-white prose-p:text-zinc-600 dark:prose-p:text-zinc-400 prose-strong:text-zinc-900 dark:prose-strong:text-white prose-li:text-zinc-600 dark:prose-li:text-zinc-400 prose-a:text-emerald-600 dark:prose-a:text-emerald-400 prose-a:no-underline hover:prose-a:text-emerald-500 dark:hover:prose-a:text-emerald-300 prose-ul:text-zinc-600 dark:prose-ul:text-zinc-400 prose-ol:text-zinc-600 dark:prose-ol:text-zinc-400">
              {guide.sections.map((section) => (
                <section key={section.id} id={section.id} className="mb-12 scroll-mt-24">
                  ...
                  <div className="mt-4 whitespace-pre-line leading-relaxed text-zinc-600 dark:text-zinc-400">
            ...
            {guide.faqs && guide.faqs.length > 0 && (
              <section className="mt-16">
                ...
                <div className="rounded-xl border border-zinc-200 dark:border-white/10 bg-zinc-50 dark:bg-zinc-900/50 p-6">
            ...
            <div className="mt-12 flex flex-wrap items-center gap-4">
              <Button asChild variant="outline" className="border-zinc-300 dark:border-white/10 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-white/5 hover:text-zinc-900 dark:hover:text-white">
                <Link href={`/category/${guide.categoryKey}`}>
                  <ArrowLeft className="mr-2 h-4 w-4" />
                  Back to {category?.title || "Category"}
                </Link>
              </Button>
              <Button asChild variant="ghost" className="text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-white/5 hover:text-zinc-900 dark:hover:text-white">
                <Link href="/guides">
                  View all guides
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24 space-y-8">
              ...
              {guide.resources && guide.resources.length > 0 && (
                <div className="rounded-xl border border-zinc-200 dark:border-white/10 bg-zinc-50 dark:bg-zinc-900/50 overflow-hidden">
                    ...
                    {guide.resources.map((resource) => {
                      ...
                      return (
                        <a
                          ...
                          className="flex items-start gap-3 rounded-lg p-2 text-sm transition-colors hover:bg-zinc-200 dark:hover:bg-white/5"
                        >
              ...
              {/* Share */}
              <div className="rounded-xl border border-zinc-200 dark:border-white/10 bg-zinc-50 dark:bg-zinc-900/50 p-6">
                <Button variant="outline" className="w-full border-zinc-300 dark:border-white/10 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-200 dark:hover:bg-white/5 hover:text-zinc-900 dark:hover:text-white" size="sm">
